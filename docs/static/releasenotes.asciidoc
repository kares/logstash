...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v7.10.1

* [710_backport] Fix docker image metadata https://github.com/elastic/logstash/pull/12451[#12451]

=== Logstash Commits between 7.10 and 7.10.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.10.0..7.10"

e01a07ca6 - (HEAD -> 7.10, upstream/7.10) Update (patch) gem versions for 7.10.1 (#12475) (6 days ago) <Karol Bucek>
2cf15a163 - remove evaluation dir from JRuby bundled did_you_mean gem (8 days ago) <Colin Surprenant>
24f2f82e4 - Revert "Moved CloudSettingId class and tests to Java" (8 days ago) <andsel>
5500235cb - [710_backport] Fix docker image metadata (#12451) (13 days ago) <Rob Bavey>
9629409cc - Moved CloudSettingId class and tests to Java (2 weeks ago) <andsel>
db4e11788 - delete pipeline in registry (#12414) (3 weeks ago) <kaisecheng>
da7f5f5f6 - hash function of pipeline config  with metadata (#12389) (3 weeks ago) <kaisecheng>
6dc872db5 - Bump version 7.10.1 (3 weeks ago) <andsel>
7bfae4828 - Release notes 7.10.0 (#12420) (3 weeks ago) <Karen Metts>
36b8b8be3 - [Backport] Doc: Add bundled JDK info (#12418) (4 weeks ago) <Karen Metts>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.10.0..7.10 *.release"
Changed plugin versions:
logstash-input-azure_event_hubs: 1.2.2 -> 1.2.3
logstash-input-http: 3.3.5 -> 3.3.6
logstash-input-sqs: 3.1.2 -> 3.1.3
logstash-integration-kafka: 10.5.1 -> 10.5.3
---------- DELETE UP TO HERE ------------
